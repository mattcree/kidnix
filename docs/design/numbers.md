...
| [Outhwaite et al. 2023](https://repec-cepeo.ucl.ac.uk/cepeow/cepeowp23-02.pdf) (SR, 50 studies, 77 apps): 92% report positive effects, 2 of 5 delayed post-tests show fade-out at 1–2 months | Claiming this teaches maths | The manifest's goal line is *"Seeing how many without counting (up to 5), and which two numbers make 5 and 10. **Practice, not a test.**"* |
